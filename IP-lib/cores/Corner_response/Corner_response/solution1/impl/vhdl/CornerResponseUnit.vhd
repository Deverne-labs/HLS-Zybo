...
architecture behav of CornerResponseUnit is 
    ...
    signal grp_CornerResponse_fu_80_ap_start : STD_LOGIC;
    signal grp_CornerResponse_fu_80_ap_done : STD_LOGIC;
    signal grp_CornerResponse_fu_80_ap_idle : STD_LOGIC;
    signal grp_CornerResponse_fu_80_ap_ready : STD_LOGIC;
    signal grp_CornerResponse_fu_80_stream_in_1_TREADY : STD_LOGIC;
    signal grp_CornerResponse_fu_80_stream_in_2_TREADY : STD_LOGIC;
    signal grp_CornerResponse_fu_80_stream_in_3_TREADY : STD_LOGIC;
    signal grp_CornerResponse_fu_80_stream_out_TDATA : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_CornerResponse_fu_80_stream_out_TVALID : STD_LOGIC;
    signal grp_CornerResponse_fu_80_stream_out_TREADY : STD_LOGIC;
    signal grp_CornerResponse_fu_80_stream_out_TKEEP : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_CornerResponse_fu_80_stream_out_TSTRB : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_CornerResponse_fu_80_stream_out_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_CornerResponse_fu_80_stream_out_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_CornerResponse_fu_80_ap_start_reg : STD_LOGIC := '0';
    ...
    signal stream_in_1_TDATA_int_regslice : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal stream_in_1_TKEEP_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stream_in_1_TSTRB_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stream_in_2_TDATA_int_regslice : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal stream_in_2_TKEEP_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stream_in_2_TSTRB_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stream_in_3_TDATA_int_regslice : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal stream_in_3_TKEEP_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stream_in_3_TSTRB_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stream_in_3_TUSER_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component CornerResponseUnit_CornerResponse IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component CornerResponseUnit_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_CornerResponse_fu_80 : component CornerResponseUnit_CornerResponse
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    regslice_both_stream_in_1_V_data_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_keep_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_strb_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_user_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_last_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_data_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_keep_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_strb_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_user_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_last_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_3_V_data_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_3_V_keep_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_3_V_strb_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_3_V_user_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_3_V_last_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_V_data_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_V_keep_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_V_strb_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_V_user_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_V_last_V_U : component CornerResponseUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    grp_CornerResponse_fu_80_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_CornerResponse_fu_80_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_CornerResponse_fu_80_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_CornerResponse_fu_80_ap_ready = ap_const_logic_1)) then 
                    grp_CornerResponse_fu_80_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_CornerResponse_fu_80_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_stream_out_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_CornerResponse_fu_80_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_CornerResponse_fu_80_ap_start <= grp_CornerResponse_fu_80_ap_start_reg;
    grp_CornerResponse_fu_80_stream_out_TREADY <= (stream_out_TREADY_int_regslice and ap_CS_fsm_state3);
    stream_in_1_TREADY <= regslice_both_stream_in_1_V_data_V_U_ack_in;

    stream_in_1_TREADY_int_regslice_assign_proc : process(grp_CornerResponse_fu_80_stream_in_1_TREADY, ap_CS_fsm_state3)
    begin
    ...
    stream_in_2_TREADY_int_regslice_assign_proc : process(grp_CornerResponse_fu_80_stream_in_2_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    stream_in_3_TREADY_int_regslice_assign_proc : process(grp_CornerResponse_fu_80_stream_in_3_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
