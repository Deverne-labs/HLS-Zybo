; ModuleID = '/home/lbo/Projects/esiee/hardware/IPs/cores/Corner_response/Corner_response/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int.1 = type { i2 }
%struct.ap_uint.2 = type { %struct.ap_int_base.3 }
%struct.ap_int_base.3 = type { %struct.ssdm_int.4 }
%struct.ssdm_int.4 = type { i1 }

; Function Attrs: noinline
define void @apatb_CornerResponseUnit_ir(%"class.hls::stream"* %stream_in_1, %"class.hls::stream"* %stream_in_2, %"class.hls::stream"* %stream_in_3, %"class.hls::stream"* %stream_out, i32 %image_w, i32 %image_h) local_unnamed_addr #0 {
entry:
  %stream_in_1_copy = alloca %"class.hls::stream", align 512
  %stream_in_2_copy = alloca %"class.hls::stream", align 512
  %stream_in_3_copy = alloca %"class.hls::stream", align 512
  %stream_out_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %stream_in_1, %"class.hls::stream"* nonnull align 512 %stream_in_1_copy, %"class.hls::stream"* %stream_in_2, %"class.hls::stream"* nonnull align 512 %stream_in_2_copy, %"class.hls::stream"* %stream_in_3, %"class.hls::stream"* nonnull align 512 %stream_in_3_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy)
  call void @apatb_CornerResponseUnit_hw(%"class.hls::stream"* %stream_in_1_copy, %"class.hls::stream"* %stream_in_2_copy, %"class.hls::stream"* %stream_in_3_copy, %"class.hls::stream"* %stream_out_copy, i32 %image_w, i32 %image_h)
  call fastcc void @copy_out(%"class.hls::stream"* %stream_in_1, %"class.hls::stream"* nonnull align 512 %stream_in_1_copy, %"class.hls::stream"* %stream_in_2, %"class.hls::stream"* nonnull align 512 %stream_in_2_copy, %"class.hls::stream"* %stream_in_3, %"class.hls::stream"* nonnull align 512 %stream_in_3_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_CornerResponseUnit_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, i32, i32)

define void @CornerResponseUnit_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, i32, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream"* null, %"class.hls::stream"* %3)
  call void @CornerResponseUnit_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream"* %2, %"class.hls::stream"* %3, i32 %4, i32 %5)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream"* null, %"class.hls::stream"* %3)
  ret void
}

declare void @CornerResponseUnit_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, i32, i32)
