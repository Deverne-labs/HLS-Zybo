...
set id 1
set name CornerResponseUnit_dsub_64ns_64ns_64_7_full_dsp_1
...
set id 2
set name CornerResponseUnit_uitodp_32s_64_6_no_dsp_1
...
set id 3
set name CornerResponseUnit_sitodp_64ns_64_6_no_dsp_1
...
set id 4
set name CornerResponseUnit_dsqrt_64ns_64ns_64_57_no_dsp_1
...
set id 5
set name CornerResponseUnit_mul_32ns_32ns_64_2_1
...
set id 6
set name CornerResponseUnit_mul_mul_16ns_16ns_30_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set id 7
set name CornerResponseUnit_mac_muladd_17s_17s_32ns_32_4_1
...
set out_width 32
set exp i0*i1+i2
set arg_lists {i0 {17 1 +} i1 {17 1 +} m {32 1 +} i2 {32 0 +} p {32 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TDATA { I 16 vector } stream_in_1_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TSTRB { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TUSER { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TREADY { O 1 bit } stream_in_1_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TDATA { I 16 vector } stream_in_2_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TSTRB { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TUSER { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TREADY { O 1 bit } stream_in_2_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TDATA { I 16 vector } stream_in_3_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TSTRB { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TUSER { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TREADY { O 1 bit } stream_in_3_TLAST { I 1 vector } } \
} "
} else {
