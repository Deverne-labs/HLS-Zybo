...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TVALID { I 1 bit } stream_in_1_TREADY { O 1 bit } stream_in_1_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TVALID { I 1 bit } stream_in_2_TREADY { O 1 bit } stream_in_2_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TDATA { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_3_TVALID { I 1 bit } stream_in_3_TREADY { O 1 bit } stream_in_3_TLAST { I 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 59
set RegSliceName CornerResponseUnit_regslice_both
set RegSliceInstName CornerResponseUnit_regslice_both_U
set CoreName ap_simcore_CornerResponseUnit_regslice_both
