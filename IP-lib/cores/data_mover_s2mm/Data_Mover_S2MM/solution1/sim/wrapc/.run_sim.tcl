...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DataMoverUnit_s2mm_32bits.autotvin.dat"
	set constFileTvOut       "DataMoverUnit_s2mm_32bits.autotvout.dat"
	set constFileHdlTvIn     "DataMoverUnit_s2mm_32bits.autohdltvin.dat"
	set constFileHdlTvOut    "DataMoverUnit_s2mm_32bits.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
