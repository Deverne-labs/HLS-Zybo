; ModuleID = '/home/lbo/Projects/esiee/hardware/IPs/cores/data_mover_s2mm/Data_Mover_S2MM/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int.8 = type { i16 }

; Function Attrs: noinline
define void @apatb_DataMoverUnit_s2mm_32bits_ir(%"class.hls::stream"* %STR_video_in, %struct.ap_uint.3* %MM_video_out, i32 %image_w, i32 %image_h, %struct.ap_uint.0* nocapture readonly %invert_X, %struct.ap_uint.0* nocapture readonly %invert_Y, %struct.ap_uint.6* %s2mm_line_buffer_size) local_unnamed_addr #0 {
entry:
  %STR_video_in_copy = alloca %"class.hls::stream", align 512
  %malloccall = tail call i8* @malloc(i64 20480)
  %MM_video_out_copy = bitcast i8* %malloccall to [5120 x %struct.ap_uint.3]*
  %s2mm_line_buffer_size_copy1 = alloca %struct.ap_uint.6, align 512
  %0 = bitcast %struct.ap_uint.3* %MM_video_out to [5120 x %struct.ap_uint.3]*
  call fastcc void @copy_in(%"class.hls::stream"* %STR_video_in, %"class.hls::stream"* nonnull align 512 %STR_video_in_copy, [5120 x %struct.ap_uint.3]* %0, [5120 x %struct.ap_uint.3]* %MM_video_out_copy, %struct.ap_uint.6* %s2mm_line_buffer_size, %struct.ap_uint.6* nonnull align 512 %s2mm_line_buffer_size_copy1)
  %1 = getelementptr inbounds [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %MM_video_out_copy, i32 0, i32 0
  call void @apatb_DataMoverUnit_s2mm_32bits_hw(%"class.hls::stream"* %STR_video_in_copy, %struct.ap_uint.3* %1, i32 %image_w, i32 %image_h, %struct.ap_uint.0* %invert_X, %struct.ap_uint.0* %invert_Y, %struct.ap_uint.6* %s2mm_line_buffer_size_copy1)
  call fastcc void @copy_out(%"class.hls::stream"* %STR_video_in, %"class.hls::stream"* nonnull align 512 %STR_video_in_copy, [5120 x %struct.ap_uint.3]* %0, [5120 x %struct.ap_uint.3]* %MM_video_out_copy, %struct.ap_uint.6* %s2mm_line_buffer_size, %struct.ap_uint.6* nonnull align 512 %s2mm_line_buffer_size_copy1)
...
; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [5120 x %struct.ap_uint.3]*, [5120 x %struct.ap_uint.3]* noalias, %struct.ap_uint.6*, %struct.ap_uint.6* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* align 512 %1, %"class.hls::stream"* %0)
  call fastcc void @onebyonecpy_hls.p0a5120struct.ap_uint.3([5120 x %struct.ap_uint.3]* %3, [5120 x %struct.ap_uint.3]* %2)
  call fastcc void @onebyonecpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* align 512 %5, %struct.ap_uint.6* %4)
  ret void
}
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a5120struct.ap_uint.3([5120 x %struct.ap_uint.3]* noalias, [5120 x %struct.ap_uint.3]* noalias) unnamed_addr #2 {
entry:
  %2 = icmp eq [5120 x %struct.ap_uint.3]* %0, null
  %3 = icmp eq [5120 x %struct.ap_uint.3]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.head, %copy
  ...
  %dst.addr = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %1, i64 0, i64 %for.loop.idx9
  %5 = bitcast %struct.ap_uint.3* %src.addr to i8*
  %6 = call i1 @fpga_fifo_exist_4(i8* %5)
  br i1 %6, label %7, label %8

; <label>:7:                                      ; preds = %for.loop
  call fastcc void @streamcpy_hls.p0struct.ap_uint.3(%struct.ap_uint.3* %dst.addr, %struct.ap_uint.3* %src.addr)
  br label %for.loop.head

; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %0, i64 0, i64 %for.loop.idx9, i32 0
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i32* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [5120 x %struct.ap_uint.3], [5120 x %struct.ap_uint.3]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* noalias align 512, %struct.ap_uint.6* noalias) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  %5 = bitcast %struct.ap_uint.6* %1 to i8*
  %6 = call i1 @fpga_fifo_exist_2(i8* %5)
  br i1 %6, label %7, label %8

; <label>:7:                                      ; preds = %copy
  call fastcc void @streamcpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* nonnull align 512 %0, %struct.ap_uint.6* nonnull %1)
  br label %ret

; <label>:8:                                      ; preds = %copy
  %.0 = getelementptr %struct.ap_uint.6, %struct.ap_uint.6* %1, i32 0, i32 0
  %.01 = getelementptr %struct.ap_uint.6, %struct.ap_uint.6* %0, i32 0, i32 0
  %9 = call i1 @fpga_fifo_exist_2(i8* %5)
  br i1 %9, label %10, label %11

; <label>:10:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.7(%struct.ap_int_base.7* align 512 %.01, %struct.ap_int_base.7* %.0)
  br label %ret

; <label>:11:                                     ; preds = %8
  %.0.02 = getelementptr %struct.ap_uint.6, %struct.ap_uint.6* %1, i32 0, i32 0, i32 0
  %.01.03 = getelementptr %struct.ap_uint.6, %struct.ap_uint.6* %0, i32 0, i32 0, i32 0
  %12 = call i1 @fpga_fifo_exist_2(i8* %5)
  br i1 %12, label %13, label %14

; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.8(%struct.ssdm_int.8* align 512 %.01.03, %struct.ssdm_int.8* %.0.02)
  br label %ret

; <label>:14:                                     ; preds = %11
  %15 = bitcast %struct.ap_uint.6* %0 to i8*
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [5120 x %struct.ap_uint.3]*, [5120 x %struct.ap_uint.3]* noalias, %struct.ap_uint.6*, %struct.ap_uint.6* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* %0, %"class.hls::stream"* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a5120struct.ap_uint.3([5120 x %struct.ap_uint.3]* %2, [5120 x %struct.ap_uint.3]* %3)
  call fastcc void @onebyonecpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* %4, %struct.ap_uint.6* align 512 %5)
  ret void
}

declare void @free(i8*) local_unnamed_addr

declare void @apatb_DataMoverUnit_s2mm_32bits_hw(%"class.hls::stream"*, %struct.ap_uint.3*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.6*)

define void @DataMoverUnit_s2mm_32bits_hw_stub_wrapper(%"class.hls::stream"*, %struct.ap_uint.3*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.6*) #6 {
entry:
  %7 = bitcast %struct.ap_uint.3* %1 to [5120 x %struct.ap_uint.3]*
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, [5120 x %struct.ap_uint.3]* null, [5120 x %struct.ap_uint.3]* %7, %struct.ap_uint.6* null, %struct.ap_uint.6* %6)
  %8 = bitcast [5120 x %struct.ap_uint.3]* %7 to %struct.ap_uint.3*
  call void @DataMoverUnit_s2mm_32bits_hw_stub(%"class.hls::stream"* %0, %struct.ap_uint.3* %8, i32 %2, i32 %3, %struct.ap_uint.0* %4, %struct.ap_uint.0* %5, %struct.ap_uint.6* %6)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, [5120 x %struct.ap_uint.3]* null, [5120 x %struct.ap_uint.3]* %7, %struct.ap_uint.6* null, %struct.ap_uint.6* %6)
  ret void
}

declare void @DataMoverUnit_s2mm_32bits_hw_stub(%"class.hls::stream"*, %struct.ap_uint.3*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.6*)
