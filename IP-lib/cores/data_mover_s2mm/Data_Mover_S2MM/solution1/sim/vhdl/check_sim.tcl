...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.DataMoverUnit_s2mm_32bits.autotvin_STR_video_in_V_data_V.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_STR_video_in_V_keep_V.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_STR_video_in_V_strb_V.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_STR_video_in_V_user_V.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_STR_video_in_V_last_V.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_MM_video_out_offset.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_image_w.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_image_h.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_invert_X.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvin_invert_Y.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvout_MM_video_out.dat"
         "c.DataMoverUnit_s2mm_32bits.autotvout_s2mm_line_buffer_size.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.DataMoverUnit_s2mm_32bits.autotvout_MM_video_out.dat"
         "rtl.DataMoverUnit_s2mm_32bits.autotvout_s2mm_line_buffer_size.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
