...
if {[file isfile DataMoverUnit_s2mm_32bits.autotvin.dat]} {
	file delete -force DataMoverUnit_s2mm_32bits.autotvin.dat
}

if {[file isfile DataMoverUnit_s2mm_32bits.autotvout.dat]} {
	file delete -force DataMoverUnit_s2mm_32bits.autotvout.dat
}
