...
############################################################
open_project Data_Mover_MM2S
set_top DataMoverUnit_mm2s_32bits
add_files src/generics_n_options.h
add_files src/data_mover_mm2s_utils.h
add_files src/data_mover_mm2s.h
add_files src/data_mover_mm2s.cpp
...
source "./Data_Mover_MM2S/solution1/directives.tcl"
csim_design
csynth_design
