...
if {[file isfile DataMoverUnit_mm2s_32bits.autotvin.dat]} {
	file delete -force DataMoverUnit_mm2s_32bits.autotvin.dat
}

if {[file isfile DataMoverUnit_mm2s_32bits.autotvout.dat]} {
	file delete -force DataMoverUnit_mm2s_32bits.autotvout.dat
}
