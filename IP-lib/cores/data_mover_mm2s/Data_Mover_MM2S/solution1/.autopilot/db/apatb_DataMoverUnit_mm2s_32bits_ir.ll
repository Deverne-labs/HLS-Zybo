; ModuleID = '/home/lbo/Projects/esiee/hardware/IPs/cores/data_mover_mm2s/Data_Mover_MM2S/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%"struct.hls::axis" = type { %struct.ap_uint.0, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3 }
...
define void @apatb_DataMoverUnit_mm2s_32bits_ir(%struct.ap_uint* %MM_video_in, %"class.hls::stream"* %STR_video_out, i32 %image_w, i32 %image_h, %struct.ap_uint.6* %mm2s_line_buffer_size) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 2211840)
  %MM_video_in_copy = bitcast i8* %malloccall to [552960 x %struct.ap_uint]*
  %STR_video_out_copy = alloca %"class.hls::stream", align 512
  %mm2s_line_buffer_size_copy1 = alloca %struct.ap_uint.6, align 512
  %0 = bitcast %struct.ap_uint* %MM_video_in to [552960 x %struct.ap_uint]*
  call fastcc void @copy_in([552960 x %struct.ap_uint]* %0, [552960 x %struct.ap_uint]* %MM_video_in_copy, %"class.hls::stream"* %STR_video_out, %"class.hls::stream"* nonnull align 512 %STR_video_out_copy, %struct.ap_uint.6* %mm2s_line_buffer_size, %struct.ap_uint.6* nonnull align 512 %mm2s_line_buffer_size_copy1)
  %1 = getelementptr inbounds [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %MM_video_in_copy, i32 0, i32 0
  call void @apatb_DataMoverUnit_mm2s_32bits_hw(%struct.ap_uint* %1, %"class.hls::stream"* %STR_video_out_copy, i32 %image_w, i32 %image_h, %struct.ap_uint.6* %mm2s_line_buffer_size_copy1)
  call fastcc void @copy_out([552960 x %struct.ap_uint]* %0, [552960 x %struct.ap_uint]* %MM_video_in_copy, %"class.hls::stream"* %STR_video_out, %"class.hls::stream"* nonnull align 512 %STR_video_out_copy, %struct.ap_uint.6* %mm2s_line_buffer_size, %struct.ap_uint.6* nonnull align 512 %mm2s_line_buffer_size_copy1)
...
; Function Attrs: noinline
define internal fastcc void @copy_in([552960 x %struct.ap_uint]*, [552960 x %struct.ap_uint]* noalias, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %struct.ap_uint.6*, %struct.ap_uint.6* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a552960struct.ap_uint([552960 x %struct.ap_uint]* %1, [552960 x %struct.ap_uint]* %0)
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a552960struct.ap_uint([552960 x %struct.ap_uint]* noalias, [552960 x %struct.ap_uint]* noalias) unnamed_addr #2 {
entry:
  %2 = icmp eq [552960 x %struct.ap_uint]* %0, null
  %3 = icmp eq [552960 x %struct.ap_uint]* %1, null
  %4 = or i1 %2, %3
...
for.loop:                                         ; preds = %for.loop.head, %copy
  ...
  %dst.addr = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i32* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [552960 x %struct.ap_uint], [552960 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
...
for.loop.head:                                    ; preds = %16, %15, %11, %7
  ...
  %exitcond = icmp ne i64 %for.loop.idx.next, 552960
...
; Function Attrs: noinline
define internal fastcc void @copy_out([552960 x %struct.ap_uint]*, [552960 x %struct.ap_uint]* noalias, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %struct.ap_uint.6*, %struct.ap_uint.6* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0a552960struct.ap_uint([552960 x %struct.ap_uint]* %0, [552960 x %struct.ap_uint]* %1)
...
declare void @apatb_DataMoverUnit_mm2s_32bits_hw(%struct.ap_uint*, %"class.hls::stream"*, i32, i32, %struct.ap_uint.6*)

define void @DataMoverUnit_mm2s_32bits_hw_stub_wrapper(%struct.ap_uint*, %"class.hls::stream"*, i32, i32, %struct.ap_uint.6*) #6 {
entry:
  %5 = bitcast %struct.ap_uint* %0 to [552960 x %struct.ap_uint]*
  call void @copy_out([552960 x %struct.ap_uint]* null, [552960 x %struct.ap_uint]* %5, %"class.hls::stream"* null, %"class.hls::stream"* %1, %struct.ap_uint.6* null, %struct.ap_uint.6* %4)
  %6 = bitcast [552960 x %struct.ap_uint]* %5 to %struct.ap_uint*
  call void @DataMoverUnit_mm2s_32bits_hw_stub(%struct.ap_uint* %6, %"class.hls::stream"* %1, i32 %2, i32 %3, %struct.ap_uint.6* %4)
  call void @copy_in([552960 x %struct.ap_uint]* null, [552960 x %struct.ap_uint]* %5, %"class.hls::stream"* null, %"class.hls::stream"* %1, %struct.ap_uint.6* null, %struct.ap_uint.6* %4)
  ret void
}

declare void @DataMoverUnit_mm2s_32bits_hw_stub(%struct.ap_uint*, %"class.hls::stream"*, i32, i32, %struct.ap_uint.6*)
