set moduleName EmptyLocalBuffer
set isTopModule 0
...
set C_modelName {EmptyLocalBuffer}
...
set C_modelArgList {
	...
	{ stream_elt_dma_buffer_V int 8 regular {array 2048 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "STR_video_out_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "stream_elt_dma_buffer_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ STR_video_out_TDATA sc_out sc_lv 8 signal 0 } 
	{ STR_video_out_TVALID sc_out sc_logic 1 outvld 4 } 
	{ STR_video_out_TREADY sc_in sc_logic 1 outacc 0 } 
	{ STR_video_out_TKEEP sc_out sc_lv 1 signal 1 } 
	{ STR_video_out_TSTRB sc_out sc_lv 1 signal 2 } 
	...
	{ i_dout sc_in sc_lv 31 signal 6 } 
	...
	{ stream_elt_dma_buffer_V_q0 sc_in sc_lv 8 signal 7 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	STR_video_out_V_data_V { axis {  { STR_video_out_TDATA out_data 1 8 }  { STR_video_out_TREADY out_acc 0 1 } } }
	...
	stream_elt_dma_buffer_V { ap_memory {  { stream_elt_dma_buffer_V_address0 mem_address 1 11 }  { stream_elt_dma_buffer_V_ce0 mem_ce 1 1 }  { stream_elt_dma_buffer_V_q0 mem_dout 0 8 } } }
}
