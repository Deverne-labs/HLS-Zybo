...
set ID 24
set hasByteEnable 0
set MemName DataMoverUnit_mm2s_32bits_dataflow_in_loop_M2S_axi_elt_dma_buffer_V_memcore
...
set MemName DataMoverUnit_mm2s_32bits_dataflow_in_loop_M2S_axi_elt_dma_buffer_V
...
set ID 25
set hasByteEnable 0
set MemName DataMoverUnit_mm2s_32bits_dataflow_in_loop_M2S_stream_elt_dma_buffer_V_memcore
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 2048
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName DataMoverUnit_mm2s_32bits_dataflow_in_loop_M2S_stream_elt_dma_buffer_V
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition:
set ID 26
set FifoName DataMoverUnit_mm2s_32bits_fifo_w32_d2_S
set InstName MM_video_in_2_c_U
...
# FIFO definition:
set ID 28
set FifoName DataMoverUnit_mm2s_32bits_fifo_w31_d2_S
set InstName i_c2_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
...
# FIFO definition:
set ID 29
set FifoName DataMoverUnit_mm2s_32bits_fifo_w32_d3_S
...
# FIFO definition:
set ID 30
set FifoName DataMoverUnit_mm2s_32bits_fifo_w31_d3_S
set InstName i_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_i \
    op interface \
    ports { i { I 31 vector } i_ap_vld { I 1 bit } } \
} "
}
