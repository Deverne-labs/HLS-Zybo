...
(* CORE_GENERATION_INFO="ColorToGrayUnit_ColorToGrayUnit,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.912000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=455,HLS_SYN_LUT=378,HLS_VERSION=2020_2}" *)
...
wire    grp_ColorToGray_fu_60_ap_start;
wire    grp_ColorToGray_fu_60_ap_done;
wire    grp_ColorToGray_fu_60_ap_idle;
wire    grp_ColorToGray_fu_60_ap_ready;
wire    grp_ColorToGray_fu_60_stream_in_TREADY;
wire   [7:0] grp_ColorToGray_fu_60_stream_out_TDATA;
wire    grp_ColorToGray_fu_60_stream_out_TVALID;
wire    grp_ColorToGray_fu_60_stream_out_TREADY;
wire   [0:0] grp_ColorToGray_fu_60_stream_out_TKEEP;
wire   [0:0] grp_ColorToGray_fu_60_stream_out_TSTRB;
wire   [0:0] grp_ColorToGray_fu_60_stream_out_TUSER;
wire   [0:0] grp_ColorToGray_fu_60_stream_out_TLAST;
reg    grp_ColorToGray_fu_60_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_ColorToGray_fu_60_ap_start_reg = 1'b0;
end

ColorToGrayUnit_ColorToGray grp_ColorToGray_fu_60(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_ColorToGray_fu_60_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_ColorToGray_fu_60_ap_start_reg <= 1'b1;
        end else if ((grp_ColorToGray_fu_60_ap_ready == 1'b1)) begin
            grp_ColorToGray_fu_60_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((regslice_both_stream_out_V_data_V_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_ColorToGray_fu_60_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_ColorToGray_fu_60_ap_start = grp_ColorToGray_fu_60_ap_start_reg;

assign grp_ColorToGray_fu_60_stream_out_TREADY = (stream_out_TREADY_int_regslice & ap_CS_fsm_state3);
