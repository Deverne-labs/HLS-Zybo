...
architecture behav of ColorToGrayUnit is 
    ...
    "ColorToGrayUnit_ColorToGrayUnit,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.912000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=455,HLS_SYN_LUT=378,HLS_VERSION=2020_2}";
    ...
    signal grp_ColorToGray_fu_60_ap_start : STD_LOGIC;
    signal grp_ColorToGray_fu_60_ap_done : STD_LOGIC;
    signal grp_ColorToGray_fu_60_ap_idle : STD_LOGIC;
    signal grp_ColorToGray_fu_60_ap_ready : STD_LOGIC;
    signal grp_ColorToGray_fu_60_stream_in_TREADY : STD_LOGIC;
    signal grp_ColorToGray_fu_60_stream_out_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_ColorToGray_fu_60_stream_out_TVALID : STD_LOGIC;
    signal grp_ColorToGray_fu_60_stream_out_TREADY : STD_LOGIC;
    signal grp_ColorToGray_fu_60_stream_out_TKEEP : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_ColorToGray_fu_60_stream_out_TSTRB : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_ColorToGray_fu_60_stream_out_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_ColorToGray_fu_60_stream_out_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_ColorToGray_fu_60_ap_start_reg : STD_LOGIC := '0';
    ...
    component ColorToGrayUnit_ColorToGray IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_ColorToGray_fu_60 : component ColorToGrayUnit_ColorToGray
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_ColorToGray_fu_60_ap_start,
        ap_done => grp_ColorToGray_fu_60_ap_done,
        ap_idle => grp_ColorToGray_fu_60_ap_idle,
        ap_ready => grp_ColorToGray_fu_60_ap_ready,
        stream_in_TDATA => stream_in_TDATA_int_regslice,
        stream_in_TVALID => stream_in_TVALID_int_regslice,
        stream_in_TREADY => grp_ColorToGray_fu_60_stream_in_TREADY,
        ...
        stream_out_TDATA => grp_ColorToGray_fu_60_stream_out_TDATA,
        stream_out_TVALID => grp_ColorToGray_fu_60_stream_out_TVALID,
        stream_out_TREADY => grp_ColorToGray_fu_60_stream_out_TREADY,
        stream_out_TKEEP => grp_ColorToGray_fu_60_stream_out_TKEEP,
        stream_out_TSTRB => grp_ColorToGray_fu_60_stream_out_TSTRB,
        stream_out_TUSER => grp_ColorToGray_fu_60_stream_out_TUSER,
        stream_out_TLAST => grp_ColorToGray_fu_60_stream_out_TLAST,
        image_w => image_w,
        image_h => image_h);
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_ColorToGray_fu_60_stream_out_TDATA,
        vld_in => grp_ColorToGray_fu_60_stream_out_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_ColorToGray_fu_60_stream_out_TKEEP,
        vld_in => grp_ColorToGray_fu_60_stream_out_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_ColorToGray_fu_60_stream_out_TSTRB,
        vld_in => grp_ColorToGray_fu_60_stream_out_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_ColorToGray_fu_60_stream_out_TUSER,
        vld_in => grp_ColorToGray_fu_60_stream_out_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_ColorToGray_fu_60_stream_out_TLAST,
        vld_in => grp_ColorToGray_fu_60_stream_out_TVALID,
    ...
    grp_ColorToGray_fu_60_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_ColorToGray_fu_60_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_ColorToGray_fu_60_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_ColorToGray_fu_60_ap_ready = ap_const_logic_1)) then 
                    grp_ColorToGray_fu_60_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_ColorToGray_fu_60_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_stream_out_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_ColorToGray_fu_60_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_ColorToGray_fu_60_ap_start <= grp_ColorToGray_fu_60_ap_start_reg;
    grp_ColorToGray_fu_60_stream_out_TREADY <= (stream_out_TREADY_int_regslice and ap_CS_fsm_state3);
    stream_in_TREADY <= regslice_both_stream_in_V_data_V_U_ack_in;

    stream_in_TREADY_int_regslice_assign_proc : process(grp_ColorToGray_fu_60_stream_in_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            stream_in_TREADY_int_regslice <= grp_ColorToGray_fu_60_stream_in_TREADY;
        else 
