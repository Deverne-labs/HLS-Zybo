...
# 2 "<built-in>" 2
# 1 "src/color_to_gray.cpp" 2
# 11 "src/color_to_gray.cpp"
# 1 "src/color_to_gray.h" 1
# 1 "src/color_to_gray_utils.h" 1
# 1 "src/generics_n_options.h" 1
# 2 "src/color_to_gray_utils.h" 2
# 1 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_utils.h" 1
# 76 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_utils.h"
...
# 77 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_utils.h" 2
# 3 "src/color_to_gray_utils.h" 2
...
# 73 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_stream_39.h"
namespace hls {
...
typedef ap_uint<1*8*3> color_video_data_elt;
typedef ap_uint<1*8> gray_video_data_elt;

typedef ap_axiu<1*8*3,1,0,0> color_video_stream_element;
typedef ap_axiu<1*8,1,0,0> gray_video_stream_element;
...
# 2 "src/color_to_gray.h" 2

__attribute__((sdx_kernel("ColorToGrayUnit", 0))) void ColorToGrayUnit(color_video_stream &stream_in,
...
void ColorToGray(color_video_stream &stream_in,
    ...
    int image_w,
    int image_h);
# 12 "src/color_to_gray.cpp" 2
# 25 "src/color_to_gray.cpp"
__attribute__((sdx_kernel("ColorToGrayUnit", 0))) void ColorToGrayUnit (color_video_stream &stream_in,
      gray_video_stream &stream_out,
      int image_w,
      int image_h){
#pragma HLS TOP name=ColorToGrayUnit
# 28 "src/color_to_gray.cpp"
...
void ColorToGray(color_video_stream &stream_in,
 ...
 static ap_uint<1*8> mean_acc;


 ap_uint<1*8> pixel_data_r;
 ap_uint<1*8> pixel_data_g;
 ap_uint<1*8> pixel_data_b;

 color_video_stream_element color_element_int;
 gray_video_stream_element gray_element_int;


 VITIS_LOOP_64_1: for(int line = 0; line < image_h; line++){
  VITIS_LOOP_65_2: for(int column = 0; column < image_w; column++){
#pragma HLS PIPELINE II = 1
 stream_in >> color_element_int;

   pixel_data_r = color_element_int.data.range(23,16);
   pixel_data_g = color_element_int.data.range(15,8);
   pixel_data_b = color_element_int.data.range(7,0);

   sum_acc = pixel_data_r + pixel_data_g + pixel_data_b;
   mean_acc = sum_acc / 3;

   gray_element_int.data = mean_acc;
   gray_element_int.user = color_element_int.user;
   gray_element_int.last = color_element_int.last;

   stream_out << gray_element_int;
