...
extern "C" void ColorToGrayUnit(__cosim_sC__*, __cosim_s7__*, int, int);
extern "C" void apatb_ColorToGrayUnit_hw(volatile void * __xlx_apatb_param_stream_in, volatile void * __xlx_apatb_param_stream_out, int __xlx_apatb_param_image_w, int __xlx_apatb_param_image_h) {
  ...
  vector<__cosim_sC__> __xlx_stream_in_tmp_vec;
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_stream_in)->empty() && __xlx_stream_in_V_tmp_Count < __xlx_stream_in_V_read_Size) {
    __xlx_stream_in_tmp_vec.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_stream_in)->read());
    __xlx_stream_in_V_tmp_Count++;
  }
  ap_apatb_stream_in_V_cap_bc = __xlx_stream_in_tmp_vec.size();
  // store input buffer
  __cosim_sC__* __xlx_stream_in_input_buffer= new __cosim_sC__[__xlx_stream_in_tmp_vec.size()];
  ...
  // DUT call
  ColorToGrayUnit(__xlx_stream_in_input_buffer, __xlx_stream_out_input_buffer, __xlx_apatb_param_image_w, __xlx_apatb_param_image_h);
