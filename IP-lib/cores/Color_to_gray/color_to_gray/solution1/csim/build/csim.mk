...
HLS_SOURCES = ../../../../src/tb.cpp ../../../../src/color_to_gray.cpp
...
$(ObjDir)/color_to_gray.o: ../../../../src/color_to_gray.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/color_to_gray.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/color_to_gray.d
