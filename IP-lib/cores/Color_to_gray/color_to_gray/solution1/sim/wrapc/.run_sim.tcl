...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ColorToGrayUnit.autotvin.dat"
	set constFileTvOut       "ColorToGrayUnit.autotvout.dat"
	set constFileHdlTvIn     "ColorToGrayUnit.autohdltvin.dat"
	set constFileHdlTvOut    "ColorToGrayUnit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
