...
if {[file isfile ColorToGrayUnit.autotvin.dat]} {
	file delete -force ColorToGrayUnit.autotvin.dat
}

if {[file isfile ColorToGrayUnit.autotvout.dat]} {
	file delete -force ColorToGrayUnit.autotvout.dat
}
