; ModuleID = '/home/lbo/Projects/esiee/hardware/IPs/cores/Color_to_gray/color_to_gray/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_ColorToGrayUnit_ir(%"class.hls::stream"* %stream_in, %"class.hls::stream.6"* %stream_out, i32 %image_w, i32 %image_h) local_unnamed_addr #0 {
entry:
  %stream_in_copy = alloca %"class.hls::stream", align 512
  %stream_out_copy = alloca %"class.hls::stream.6", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %stream_in, %"class.hls::stream"* nonnull align 512 %stream_in_copy, %"class.hls::stream.6"* %stream_out, %"class.hls::stream.6"* nonnull align 512 %stream_out_copy)
  call void @apatb_ColorToGrayUnit_hw(%"class.hls::stream"* %stream_in_copy, %"class.hls::stream.6"* %stream_out_copy, i32 %image_w, i32 %image_h)
  call fastcc void @copy_out(%"class.hls::stream"* %stream_in, %"class.hls::stream"* nonnull align 512 %stream_in_copy, %"class.hls::stream.6"* %stream_out, %"class.hls::stream.6"* nonnull align 512 %stream_out_copy)
  ret void
}
...
declare void @apatb_ColorToGrayUnit_hw(%"class.hls::stream"*, %"class.hls::stream.6"*, i32, i32)

define void @ColorToGrayUnit_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.6"*, i32, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1)
  call void @ColorToGrayUnit_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.6"* %1, i32 %2, i32 %3)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1)
  ret void
}

declare void @ColorToGrayUnit_hw_stub(%"class.hls::stream"*, %"class.hls::stream.6"*, i32, i32)
