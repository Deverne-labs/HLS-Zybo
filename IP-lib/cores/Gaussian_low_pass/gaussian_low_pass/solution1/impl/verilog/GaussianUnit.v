...
wire    grp_Gaussian_fu_110_ap_start;
wire    grp_Gaussian_fu_110_ap_done;
wire    grp_Gaussian_fu_110_ap_idle;
wire    grp_Gaussian_fu_110_ap_ready;
wire    grp_Gaussian_fu_110_stream_in_TREADY;
wire   [15:0] grp_Gaussian_fu_110_stream_out_TDATA;
wire    grp_Gaussian_fu_110_stream_out_TVALID;
wire    grp_Gaussian_fu_110_stream_out_TREADY;
wire   [1:0] grp_Gaussian_fu_110_stream_out_TKEEP;
wire   [1:0] grp_Gaussian_fu_110_stream_out_TSTRB;
wire   [0:0] grp_Gaussian_fu_110_stream_out_TUSER;
wire   [0:0] grp_Gaussian_fu_110_stream_out_TLAST;
reg    grp_Gaussian_fu_110_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_Gaussian_fu_110_ap_start_reg = 1'b0;
end

GaussianUnit_Gaussian grp_Gaussian_fu_110(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_Gaussian_fu_110_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_Gaussian_fu_110_ap_start_reg <= 1'b1;
        end else if ((grp_Gaussian_fu_110_ap_ready == 1'b1)) begin
            grp_Gaussian_fu_110_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_Gaussian_fu_110_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_Gaussian_fu_110_ap_start = grp_Gaussian_fu_110_ap_start_reg;

assign grp_Gaussian_fu_110_stream_out_TREADY = (stream_out_TREADY_int_regslice & ap_CS_fsm_state3);
