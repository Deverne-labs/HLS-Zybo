...
set id 1
set name GaussianUnit_mul_32ns_32ns_64_2_1
...
set ID 3
set hasByteEnable 0
set MemName GaussianUnit_Gaussian_line_buffer_V_1
...
set ID 4
set hasByteEnable 0
set MemName GaussianUnit_Gaussian_line_buffer_V_0
set CoreName ap_simcore_mem
set PortList { 0 3 }
set DataWd 16
set AddrRange 2048
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_TDATA { I 16 vector } stream_in_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_TSTRB { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TDATA { O 16 vector } stream_out_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TKEEP { O 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TSTRB { O 2 vector } } \
} "
} else {
