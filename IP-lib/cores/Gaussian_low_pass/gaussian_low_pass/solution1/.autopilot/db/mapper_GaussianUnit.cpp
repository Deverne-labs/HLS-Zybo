...
extern "C" void GaussianUnit(__cosim_s8__*, __cosim_s8__*, int, int);
extern "C" void apatb_GaussianUnit_hw(volatile void * __xlx_apatb_param_stream_in, volatile void * __xlx_apatb_param_stream_out, int __xlx_apatb_param_image_w, int __xlx_apatb_param_image_h) {
  ...
  // DUT call
  GaussianUnit(__xlx_stream_in_input_buffer, __xlx_stream_out_input_buffer, __xlx_apatb_param_image_w, __xlx_apatb_param_image_h);
