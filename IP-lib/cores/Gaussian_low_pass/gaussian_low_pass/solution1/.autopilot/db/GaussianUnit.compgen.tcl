...
# RegSlice definition:
set ID 29
set RegSliceName GaussianUnit_regslice_both
set RegSliceInstName GaussianUnit_regslice_both_U
set CoreName ap_simcore_GaussianUnit_regslice_both
