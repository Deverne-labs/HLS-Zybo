...
$(ObjDir)/non_maximal_suppresion.cpp_pre.cpp.tb.o : non_maximal_suppresion.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling non_maximal_suppresion.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
