...
define void @apatb_NonMaximalSuppresionUnit_ir(%"class.hls::stream"* %stream_in, %"class.hls::stream.9"* %stream_out, i32 %image_w, i32 %image_h, %struct.ap_uint.0* nocapture readonly %alpha, %struct.ap_uint.0* nocapture readonly %beta) local_unnamed_addr #0 {
entry:
  %stream_in_copy = alloca %"class.hls::stream", align 512
  %stream_out_copy = alloca %"class.hls::stream.9", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %stream_in, %"class.hls::stream"* nonnull align 512 %stream_in_copy, %"class.hls::stream.9"* %stream_out, %"class.hls::stream.9"* nonnull align 512 %stream_out_copy)
  call void @apatb_NonMaximalSuppresionUnit_hw(%"class.hls::stream"* %stream_in_copy, %"class.hls::stream.9"* %stream_out_copy, i32 %image_w, i32 %image_h, %struct.ap_uint.0* %alpha, %struct.ap_uint.0* %beta)
  call fastcc void @copy_out(%"class.hls::stream"* %stream_in, %"class.hls::stream"* nonnull align 512 %stream_in_copy, %"class.hls::stream.9"* %stream_out, %"class.hls::stream.9"* nonnull align 512 %stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.9"*, %"class.hls::stream.9"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.9"*, %"class.hls::stream.9"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_NonMaximalSuppresionUnit_hw(%"class.hls::stream"*, %"class.hls::stream.9"*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*)

define void @NonMaximalSuppresionUnit_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.9"*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.9"* null, %"class.hls::stream.9"* %1)
  call void @NonMaximalSuppresionUnit_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.9"* %1, i32 %2, i32 %3, %struct.ap_uint.0* %4, %struct.ap_uint.0* %5)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.9"* null, %"class.hls::stream.9"* %1)
  ret void
}

declare void @NonMaximalSuppresionUnit_hw_stub(%"class.hls::stream"*, %"class.hls::stream.9"*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*)
