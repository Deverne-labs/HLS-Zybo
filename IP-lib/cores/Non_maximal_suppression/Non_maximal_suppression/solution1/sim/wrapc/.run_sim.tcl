...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "NonMaximalSuppresionUnit.autotvin.dat"
	set constFileTvOut       "NonMaximalSuppresionUnit.autotvout.dat"
	set constFileHdlTvIn     "NonMaximalSuppresionUnit.autohdltvin.dat"
	set constFileHdlTvOut    "NonMaximalSuppresionUnit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
