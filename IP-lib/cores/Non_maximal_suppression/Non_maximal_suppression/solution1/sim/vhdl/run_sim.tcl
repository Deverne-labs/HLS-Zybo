...
if {[file isfile NonMaximalSuppresionUnit.autotvin.dat]} {
	file delete -force NonMaximalSuppresionUnit.autotvin.dat
}

if {[file isfile NonMaximalSuppresionUnit.autotvout.dat]} {
	file delete -force NonMaximalSuppresionUnit.autotvout.dat
}
