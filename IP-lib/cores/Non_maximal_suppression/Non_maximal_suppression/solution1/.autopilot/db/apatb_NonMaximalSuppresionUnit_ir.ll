; ModuleID = '/home/lbo/Projects/esiee/hardware/IPs/cores/Non_maximal_suppression/Non_maximal_suppression/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%"class.hls::stream.9" = type { %"struct.hls::axis.10" }
%"struct.hls::axis.10" = type { %struct.ap_uint.11, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.6 }
%struct.ap_uint.11 = type { %struct.ap_int_base.12 }
%struct.ap_int_base.12 = type { %struct.ssdm_int.13 }
%struct.ssdm_int.13 = type { i8 }

; Function Attrs: noinline
define void @apatb_NonMaximalSuppresionUnit_ir(%"class.hls::stream"* %stream_in, %"class.hls::stream.9"* %stream_out, i32 %image_w, i32 %image_h, %struct.ap_uint.0* nocapture readonly %alpha, %struct.ap_uint.0* nocapture readonly %beta, %struct.ap_uint.0* %max_response) local_unnamed_addr #0 {
entry:
  %stream_in_copy = alloca %"class.hls::stream", align 512
  %stream_out_copy = alloca %"class.hls::stream.9", align 512
  %max_response_copy1 = alloca %struct.ap_uint.0, align 512
  call fastcc void @copy_in(%"class.hls::stream"* %stream_in, %"class.hls::stream"* nonnull align 512 %stream_in_copy, %"class.hls::stream.9"* %stream_out, %"class.hls::stream.9"* nonnull align 512 %stream_out_copy, %struct.ap_uint.0* %max_response, %struct.ap_uint.0* nonnull align 512 %max_response_copy1)
  call void @apatb_NonMaximalSuppresionUnit_hw(%"class.hls::stream"* %stream_in_copy, %"class.hls::stream.9"* %stream_out_copy, i32 %image_w, i32 %image_h, %struct.ap_uint.0* %alpha, %struct.ap_uint.0* %beta, %struct.ap_uint.0* %max_response_copy1)
  call fastcc void @copy_out(%"class.hls::stream"* %stream_in, %"class.hls::stream"* nonnull align 512 %stream_in_copy, %"class.hls::stream.9"* %stream_out, %"class.hls::stream.9"* nonnull align 512 %stream_out_copy, %struct.ap_uint.0* %max_response, %struct.ap_uint.0* nonnull align 512 %max_response_copy1)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.9"*, %"class.hls::stream.9"* noalias align 512, %struct.ap_uint.0*, %struct.ap_uint.0* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* align 512 %1, %"class.hls::stream"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.9"(%"class.hls::stream.9"* align 512 %3, %"class.hls::stream.9"* %2)
...
copy:                                             ; preds = %entry
  %5 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
; <label>:17:                                     ; preds = %14
  %.01.0.0.0.09 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
; <label>:18:                                     ; preds = %17, %16, %13, %10
  ...
  %19 = bitcast %struct.ap_uint.6* %.0.110 to i8*
...
; <label>:22:                                     ; preds = %18
  ...
  %23 = bitcast %struct.ap_int_base.7* %.0.1.012 to i8*
...
; <label>:26:                                     ; preds = %22
  ...
  %27 = bitcast %struct.ssdm_int.8* %.0.1.0.014 to i8*
...
; <label>:30:                                     ; preds = %26
  %.01.1.0.0.017.gep58 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %31 = bitcast i1* %.01.1.0.0.017.gep58 to i8*
  %.0.1.0.0.016.gep59 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:33:                                     ; preds = %30, %29, %25, %21
  ...
  %34 = bitcast %struct.ap_uint.6* %.0.218 to i8*
...
; <label>:37:                                     ; preds = %33
  ...
  %38 = bitcast %struct.ap_int_base.7* %.0.2.020 to i8*
...
; <label>:41:                                     ; preds = %37
  ...
  %42 = bitcast %struct.ssdm_int.8* %.0.2.0.022 to i8*
...
; <label>:45:                                     ; preds = %41
  %.01.2.0.0.025.gep60 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %46 = bitcast i1* %.01.2.0.0.025.gep60 to i8*
  %.0.2.0.0.024.gep61 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:48:                                     ; preds = %45, %44, %40, %36
  ...
  %49 = bitcast %struct.ap_uint.6* %.0.326 to i8*
...
; <label>:52:                                     ; preds = %48
  ...
  %53 = bitcast %struct.ap_int_base.7* %.0.3.028 to i8*
...
; <label>:56:                                     ; preds = %52
  ...
  %57 = bitcast %struct.ssdm_int.8* %.0.3.0.030 to i8*
...
; <label>:60:                                     ; preds = %56
  %.01.3.0.0.033.gep62 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %61 = bitcast i1* %.01.3.0.0.033.gep62 to i8*
  %.0.3.0.0.032.gep63 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
...
; <label>:63:                                     ; preds = %60, %59, %55, %51
  ...
  %64 = bitcast %struct.ap_uint.6* %.0.434 to i8*
...
; <label>:67:                                     ; preds = %63
  ...
  %68 = bitcast %struct.ap_int_base.7* %.0.4.036 to i8*
...
; <label>:71:                                     ; preds = %67
  ...
  %72 = bitcast %struct.ssdm_int.8* %.0.4.0.038 to i8*
...
; <label>:75:                                     ; preds = %71
  %.01.4.0.0.041.gep64 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %76 = bitcast i1* %.01.4.0.0.041.gep64 to i8*
  %.0.4.0.0.040.gep65 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
...
; <label>:78:                                     ; preds = %75, %74, %70, %66
  ...
  %79 = bitcast %struct.ap_uint.6* %.0.542 to i8*
...
; <label>:82:                                     ; preds = %78
  ...
  %83 = bitcast %struct.ap_int_base.7* %.0.5.044 to i8*
...
; <label>:86:                                     ; preds = %82
  ...
  %87 = bitcast %struct.ssdm_int.8* %.0.5.0.046 to i8*
...
; <label>:90:                                     ; preds = %86
  %.01.5.0.0.049.gep66 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %91 = bitcast i1* %.01.5.0.0.049.gep66 to i8*
  %.0.5.0.0.048.gep67 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
...
; <label>:93:                                     ; preds = %90, %89, %85, %81
  ...
  %94 = bitcast %struct.ap_uint.6* %.0.650 to i8*
...
; <label>:97:                                     ; preds = %93
  ...
  %98 = bitcast %struct.ap_int_base.7* %.0.6.052 to i8*
...
; <label>:101:                                    ; preds = %97
  ...
  %102 = bitcast %struct.ssdm_int.8* %.0.6.0.054 to i8*
...
; <label>:105:                                    ; preds = %101
  %.01.6.0.0.057.gep68 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %106 = bitcast i1* %.01.6.0.0.057.gep68 to i8*
  %.0.6.0.0.056.gep69 = getelementptr %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
...
ret:                                              ; preds = %empty
  %10 = getelementptr inbounds %"class.hls::stream.9", %"class.hls::stream.9"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
  %11 = getelementptr inbounds %"class.hls::stream.9", %"class.hls::stream.9"* %0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.9"*, %"class.hls::stream.9"* noalias align 512, %struct.ap_uint.0*, %struct.ap_uint.0* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* %0, %"class.hls::stream"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.9"(%"class.hls::stream.9"* %2, %"class.hls::stream.9"* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0struct.ap_uint.0(%struct.ap_uint.0* %4, %struct.ap_uint.0* align 512 %5)
  ret void
}

declare void @apatb_NonMaximalSuppresionUnit_hw(%"class.hls::stream"*, %"class.hls::stream.9"*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*)

define void @NonMaximalSuppresionUnit_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.9"*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.9"* null, %"class.hls::stream.9"* %1, %struct.ap_uint.0* null, %struct.ap_uint.0* %6)
  call void @NonMaximalSuppresionUnit_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.9"* %1, i32 %2, i32 %3, %struct.ap_uint.0* %4, %struct.ap_uint.0* %5, %struct.ap_uint.0* %6)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.9"* null, %"class.hls::stream.9"* %1, %struct.ap_uint.0* null, %struct.ap_uint.0* %6)
  ret void
}

declare void @NonMaximalSuppresionUnit_hw_stub(%"class.hls::stream"*, %"class.hls::stream.9"*, i32, i32, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*)
