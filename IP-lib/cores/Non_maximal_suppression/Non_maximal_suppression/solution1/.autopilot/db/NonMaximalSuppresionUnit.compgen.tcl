...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TDATA { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_max_response \
    op interface \
    ports { max_response { O 16 vector } max_response_ap_vld { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 36
set RegSliceName NonMaximalSuppresionUnit_regslice_both
set RegSliceInstName NonMaximalSuppresionUnit_regslice_both_U
set CoreName ap_simcore_NonMaximalSuppresionUnit_regslice_both
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix NonMaximalSuppresionUnit_ \
    sliceTypeList 0\
}"
} else {
