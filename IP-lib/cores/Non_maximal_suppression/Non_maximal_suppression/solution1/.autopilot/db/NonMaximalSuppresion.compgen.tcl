...
set id 1
set name NonMaximalSuppresionUnit_mul_32ns_32ns_64_2_1
...
set id 2
set name NonMaximalSuppresionUnit_mul_mul_16ns_16ns_32_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set ID 5
set hasByteEnable 0
set MemName NonMaximalSuppresionUnit_NonMaximalSuppresion_line_buffer_V_1
...
set ID 6
set hasByteEnable 0
set MemName NonMaximalSuppresionUnit_NonMaximalSuppresion_line_buffer_V_0
set CoreName ap_simcore_mem
set PortList { 0 3 }
set DataWd 16
set AddrRange 2048
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TDATA { O 8 vector } stream_out_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TKEEP { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TSTRB { O 1 vector } } \
} "
} else {
