...
architecture behav of NonMaximalSuppresionUnit is 
    ...
    signal grp_NonMaximalSuppresion_fu_109_ap_start : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_ap_done : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_ap_idle : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_ap_ready : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_stream_in_TREADY : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TVALID : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TREADY : STD_LOGIC;
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TKEEP : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TSTRB : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_NonMaximalSuppresion_fu_109_stream_out_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_NonMaximalSuppresion_fu_109_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_NonMaximalSuppresion_fu_109_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_NonMaximalSuppresion_fu_109 : component NonMaximalSuppresionUnit_NonMaximalSuppresion
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_NonMaximalSuppresion_fu_109_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_NonMaximalSuppresion_fu_109_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_NonMaximalSuppresion_fu_109_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_NonMaximalSuppresion_fu_109_ap_ready = ap_const_logic_1)) then 
                    grp_NonMaximalSuppresion_fu_109_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_NonMaximalSuppresion_fu_109_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_stream_out_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_NonMaximalSuppresion_fu_109_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_NonMaximalSuppresion_fu_109_ap_start <= grp_NonMaximalSuppresion_fu_109_ap_start_reg;
    grp_NonMaximalSuppresion_fu_109_stream_out_TREADY <= (stream_out_TREADY_int_regslice and ap_CS_fsm_state3);
    max_response <= grp_NonMaximalSuppresion_fu_109_ap_return;

    max_response_ap_vld_assign_proc : process(grp_NonMaximalSuppresion_fu_109_ap_done, ap_CS_fsm_state3)
    begin
        if (((grp_NonMaximalSuppresion_fu_109_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            max_response_ap_vld <= ap_const_logic_1;
        else 
            max_response_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    stream_in_TREADY <= regslice_both_stream_in_V_data_V_U_ack_in;

    stream_in_TREADY_int_regslice_assign_proc : process(grp_NonMaximalSuppresion_fu_109_stream_in_TREADY, ap_CS_fsm_state3)
    begin
