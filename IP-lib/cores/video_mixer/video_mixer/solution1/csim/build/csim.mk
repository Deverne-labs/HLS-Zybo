...
HLS_SOURCES = ../../../../src/tb.cpp ../../../../src/video_mixer.cpp
...
$(ObjDir)/video_mixer.o: ../../../../src/video_mixer.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/video_mixer.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/video_mixer.d
