...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "VideoMixerUnit.autotvin.dat"
	set constFileTvOut       "VideoMixerUnit.autotvout.dat"
	set constFileHdlTvIn     "VideoMixerUnit.autohdltvin.dat"
	set constFileHdlTvOut    "VideoMixerUnit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
