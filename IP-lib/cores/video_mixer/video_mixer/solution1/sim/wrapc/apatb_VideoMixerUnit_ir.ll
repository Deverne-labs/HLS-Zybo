; ModuleID = '/home/lbo/Projects/Photospace/PH920/FPGA/Mercury_XU5EV/hardware/IPs/cores/video_mixer/video_mixer/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_VideoMixerUnit_ir(%"class.hls::stream"* %video_stream_in, %"class.hls::stream.3"* %overlay_stream_in, %"class.hls::stream"* %video_stream_out, i32 %image_h, i32 %image_w) local_unnamed_addr #0 {
entry:
  %video_stream_in_copy = alloca %"class.hls::stream", align 512
  %overlay_stream_in_copy = alloca %"class.hls::stream.3", align 512
  %video_stream_out_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %video_stream_in, %"class.hls::stream"* nonnull align 512 %video_stream_in_copy, %"class.hls::stream.3"* %overlay_stream_in, %"class.hls::stream.3"* nonnull align 512 %overlay_stream_in_copy, %"class.hls::stream"* %video_stream_out, %"class.hls::stream"* nonnull align 512 %video_stream_out_copy)
  call void @apatb_VideoMixerUnit_hw(%"class.hls::stream"* %video_stream_in_copy, %"class.hls::stream.3"* %overlay_stream_in_copy, %"class.hls::stream"* %video_stream_out_copy, i32 %image_h, i32 %image_w)
  call fastcc void @copy_out(%"class.hls::stream"* %video_stream_in, %"class.hls::stream"* nonnull align 512 %video_stream_in_copy, %"class.hls::stream.3"* %overlay_stream_in, %"class.hls::stream.3"* nonnull align 512 %overlay_stream_in_copy, %"class.hls::stream"* %video_stream_out, %"class.hls::stream"* nonnull align 512 %video_stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.3"*, %"class.hls::stream.3"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.3"*, %"class.hls::stream.3"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_VideoMixerUnit_hw(%"class.hls::stream"*, %"class.hls::stream.3"*, %"class.hls::stream"*, i32, i32)

define void @VideoMixerUnit_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.3"*, %"class.hls::stream"*, i32, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.3"* null, %"class.hls::stream.3"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2)
  call void @VideoMixerUnit_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.3"* %1, %"class.hls::stream"* %2, i32 %3, i32 %4)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.3"* null, %"class.hls::stream.3"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2)
  ret void
}

declare void @VideoMixerUnit_hw_stub(%"class.hls::stream"*, %"class.hls::stream.3"*, %"class.hls::stream"*, i32, i32)
