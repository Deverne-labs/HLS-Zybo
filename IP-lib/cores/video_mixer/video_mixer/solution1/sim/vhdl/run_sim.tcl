...
if {[file isfile VideoMixerUnit.autotvin.dat]} {
	file delete -force VideoMixerUnit.autotvin.dat
}

if {[file isfile VideoMixerUnit.autotvout.dat]} {
	file delete -force VideoMixerUnit.autotvout.dat
}
