...
wire    grp_GradConvolution_fu_70_ap_start;
wire    grp_GradConvolution_fu_70_ap_done;
wire    grp_GradConvolution_fu_70_ap_idle;
wire    grp_GradConvolution_fu_70_ap_ready;
wire    grp_GradConvolution_fu_70_stream_in_1_TREADY;
wire    grp_GradConvolution_fu_70_stream_in_2_TREADY;
wire   [15:0] grp_GradConvolution_fu_70_stream_out_TDATA;
wire    grp_GradConvolution_fu_70_stream_out_TVALID;
wire    grp_GradConvolution_fu_70_stream_out_TREADY;
wire   [1:0] grp_GradConvolution_fu_70_stream_out_TKEEP;
wire   [1:0] grp_GradConvolution_fu_70_stream_out_TSTRB;
wire   [0:0] grp_GradConvolution_fu_70_stream_out_TUSER;
wire   [0:0] grp_GradConvolution_fu_70_stream_out_TLAST;
reg    grp_GradConvolution_fu_70_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire    regslice_both_stream_out_V_data_V_U_apdone_blk;
reg   [3:0] ap_NS_fsm;
wire    regslice_both_stream_in_1_V_data_V_U_apdone_blk;
wire   [7:0] stream_in_1_TDATA_int_regslice;
...
wire   [0:0] stream_in_1_TKEEP_int_regslice;
...
wire   [0:0] stream_in_1_TSTRB_int_regslice;
...
wire   [7:0] stream_in_2_TDATA_int_regslice;
...
wire   [0:0] stream_in_2_TKEEP_int_regslice;
...
wire   [0:0] stream_in_2_TSTRB_int_regslice;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_GradConvolution_fu_70_ap_start_reg = 1'b0;
end

GradConvolutionUnit_GradConvolution grp_GradConvolution_fu_70(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
GradConvolutionUnit_regslice_both #(
    .DataWidth( 8 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_GradConvolution_fu_70_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_GradConvolution_fu_70_ap_start_reg <= 1'b1;
        end else if ((grp_GradConvolution_fu_70_ap_ready == 1'b1)) begin
            grp_GradConvolution_fu_70_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_GradConvolution_fu_70_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_GradConvolution_fu_70_ap_start = grp_GradConvolution_fu_70_ap_start_reg;

assign grp_GradConvolution_fu_70_stream_out_TREADY = (stream_out_TREADY_int_regslice & ap_CS_fsm_state3);
