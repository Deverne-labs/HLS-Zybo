...
architecture behav of GradConvolutionUnit is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "GradConvolutionUnit_GradConvolutionUnit,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.912000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=352,HLS_SYN_LUT=611,HLS_VERSION=2020_2}";
    ...
    signal grp_GradConvolution_fu_70_ap_start : STD_LOGIC;
    signal grp_GradConvolution_fu_70_ap_done : STD_LOGIC;
    signal grp_GradConvolution_fu_70_ap_idle : STD_LOGIC;
    signal grp_GradConvolution_fu_70_ap_ready : STD_LOGIC;
    signal grp_GradConvolution_fu_70_stream_in_1_TREADY : STD_LOGIC;
    signal grp_GradConvolution_fu_70_stream_in_2_TREADY : STD_LOGIC;
    signal grp_GradConvolution_fu_70_stream_out_TDATA : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_GradConvolution_fu_70_stream_out_TVALID : STD_LOGIC;
    signal grp_GradConvolution_fu_70_stream_out_TREADY : STD_LOGIC;
    signal grp_GradConvolution_fu_70_stream_out_TKEEP : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_GradConvolution_fu_70_stream_out_TSTRB : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_GradConvolution_fu_70_stream_out_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_GradConvolution_fu_70_stream_out_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_GradConvolution_fu_70_ap_start_reg : STD_LOGIC := '0';
    ...
    signal stream_in_1_TDATA_int_regslice : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal stream_in_1_TKEEP_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal stream_in_1_TSTRB_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal stream_in_1_TUSER_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal stream_in_2_TDATA_int_regslice : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal stream_in_2_TKEEP_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal stream_in_2_TSTRB_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal stream_in_2_TUSER_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component GradConvolutionUnit_GradConvolution IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component GradConvolutionUnit_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_GradConvolution_fu_70 : component GradConvolutionUnit_GradConvolution
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_GradConvolution_fu_70_ap_start,
        ap_done => grp_GradConvolution_fu_70_ap_done,
        ap_idle => grp_GradConvolution_fu_70_ap_idle,
        ap_ready => grp_GradConvolution_fu_70_ap_ready,
        stream_in_1_TDATA => stream_in_1_TDATA_int_regslice,
        stream_in_1_TVALID => stream_in_1_TVALID_int_regslice,
        stream_in_1_TREADY => grp_GradConvolution_fu_70_stream_in_1_TREADY,
        ...
        stream_in_2_TREADY => grp_GradConvolution_fu_70_stream_in_2_TREADY,
        ...
        stream_out_TDATA => grp_GradConvolution_fu_70_stream_out_TDATA,
        stream_out_TVALID => grp_GradConvolution_fu_70_stream_out_TVALID,
        stream_out_TREADY => grp_GradConvolution_fu_70_stream_out_TREADY,
        stream_out_TKEEP => grp_GradConvolution_fu_70_stream_out_TKEEP,
        stream_out_TSTRB => grp_GradConvolution_fu_70_stream_out_TSTRB,
        stream_out_TUSER => grp_GradConvolution_fu_70_stream_out_TUSER,
        stream_out_TLAST => grp_GradConvolution_fu_70_stream_out_TLAST,
        image_w => image_w,
        image_h => image_h);

    regslice_both_stream_in_1_V_data_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_keep_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_strb_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_user_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_1_V_last_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_data_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_keep_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_strb_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_user_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_2_V_last_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_V_data_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_GradConvolution_fu_70_stream_out_TDATA,
        vld_in => grp_GradConvolution_fu_70_stream_out_TVALID,
    ...
    regslice_both_stream_out_V_keep_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_GradConvolution_fu_70_stream_out_TKEEP,
        vld_in => grp_GradConvolution_fu_70_stream_out_TVALID,
    ...
    regslice_both_stream_out_V_strb_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_GradConvolution_fu_70_stream_out_TSTRB,
        vld_in => grp_GradConvolution_fu_70_stream_out_TVALID,
    ...
    regslice_both_stream_out_V_user_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_GradConvolution_fu_70_stream_out_TUSER,
        vld_in => grp_GradConvolution_fu_70_stream_out_TVALID,
    ...
    regslice_both_stream_out_V_last_V_U : component GradConvolutionUnit_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_GradConvolution_fu_70_stream_out_TLAST,
        vld_in => grp_GradConvolution_fu_70_stream_out_TVALID,
    ...
    grp_GradConvolution_fu_70_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_GradConvolution_fu_70_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_GradConvolution_fu_70_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_GradConvolution_fu_70_ap_ready = ap_const_logic_1)) then 
                    grp_GradConvolution_fu_70_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_GradConvolution_fu_70_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_stream_out_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_GradConvolution_fu_70_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_GradConvolution_fu_70_ap_start <= grp_GradConvolution_fu_70_ap_start_reg;
    grp_GradConvolution_fu_70_stream_out_TREADY <= (stream_out_TREADY_int_regslice and ap_CS_fsm_state3);
    stream_in_1_TREADY <= regslice_both_stream_in_1_V_data_V_U_ack_in;

    stream_in_1_TREADY_int_regslice_assign_proc : process(grp_GradConvolution_fu_70_stream_in_1_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            stream_in_1_TREADY_int_regslice <= grp_GradConvolution_fu_70_stream_in_1_TREADY;
        else 
    ...
    stream_in_2_TREADY_int_regslice_assign_proc : process(grp_GradConvolution_fu_70_stream_in_2_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            stream_in_2_TREADY_int_regslice <= grp_GradConvolution_fu_70_stream_in_2_TREADY;
        else 
