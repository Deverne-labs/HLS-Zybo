...
set id 1
set name GradConvolutionUnit_mul_32ns_32ns_64_2_1
...
set id 2
set name GradConvolutionUnit_mul_8ns_8ns_16_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_1_TDATA { I 8 vector } stream_in_1_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_2_TDATA { I 8 vector } stream_in_2_TVALID { I 1 bit } } \
} "
} else {
