# 1 "src/gradient_convolution.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/gradient_convolution.cpp" 2
# 11 "src/gradient_convolution.cpp"
# 1 "src/gradient_convolution.h" 1
# 1 "src/gradient_convolution_utils.h" 1
# 1 "src/generics_n_options.h" 1
# 2 "src/gradient_convolution_utils.h" 2
...
# 3 "src/gradient_convolution_utils.h" 2
...
# 4 "src/gradient_convolution_utils.h" 2
...
# 5 "src/gradient_convolution_utils.h" 2
# 14 "src/gradient_convolution_utils.h"
typedef ap_axiu<8*1,1,0,0> in_video_stream_element;
typedef ap_axiu<8*2,1,0,0> out_video_stream_element;

typedef hls::stream<in_video_stream_element> in_video_stream;
typedef hls::stream<out_video_stream_element> out_video_stream;
# 2 "src/gradient_convolution.h" 2

__attribute__((sdx_kernel("GradConvolutionUnit", 0))) void GradConvolutionUnit(in_video_stream &stream_in_1,
...
void GradConvolution(in_video_stream &stream_in_1,
    ...
    int image_w,
    int image_h);
# 12 "src/gradient_convolution.cpp" 2
# 25 "src/gradient_convolution.cpp"
__attribute__((sdx_kernel("GradConvolutionUnit", 0))) void GradConvolutionUnit (in_video_stream &stream_in_1,
      in_video_stream &stream_in_2,
      out_video_stream &stream_out,
      int image_w,
      int image_h){
#pragma HLS TOP name=GradConvolutionUnit
# 29 "src/gradient_convolution.cpp"
...
# 47 "src/gradient_convolution.cpp"
void GradConvolution(in_video_stream &stream_in_1,
    in_video_stream &stream_in_2,
    out_video_stream &stream_out,
    int image_w,
 ...
 static ap_int<32> multiply_register;


 VITIS_LOOP_59_1: for(int line = 0; line < image_h; line++){
  VITIS_LOOP_60_2: for(int column = 0; column < image_w; column++){
#pragma HLS PIPELINE II = 1
 stream_in_1 >> in_element_int_1;
   stream_in_2 >> in_element_int_2;

   multiply_register = in_element_int_1.data * in_element_int_2.data;
   out_element_int.user = (line == 0 && column == 0);
   out_element_int.last = (column == image_w -1);
   out_element_int.data = multiply_register;
   stream_out << out_element_int;
