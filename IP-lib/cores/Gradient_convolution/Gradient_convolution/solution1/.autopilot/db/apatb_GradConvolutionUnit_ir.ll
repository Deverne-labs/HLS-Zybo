; ModuleID = '/home/lbo/Projects/esiee/hardware/IPs/cores/Gradient_convolution/Gradient_convolution/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_GradConvolutionUnit_ir(%"class.hls::stream"* %stream_in_1, %"class.hls::stream"* %stream_in_2, %"class.hls::stream.3"* %stream_out, i32 %image_w, i32 %image_h) local_unnamed_addr #0 {
entry:
  %stream_in_1_copy = alloca %"class.hls::stream", align 512
  %stream_in_2_copy = alloca %"class.hls::stream", align 512
  %stream_out_copy = alloca %"class.hls::stream.3", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %stream_in_1, %"class.hls::stream"* nonnull align 512 %stream_in_1_copy, %"class.hls::stream"* %stream_in_2, %"class.hls::stream"* nonnull align 512 %stream_in_2_copy, %"class.hls::stream.3"* %stream_out, %"class.hls::stream.3"* nonnull align 512 %stream_out_copy)
  call void @apatb_GradConvolutionUnit_hw(%"class.hls::stream"* %stream_in_1_copy, %"class.hls::stream"* %stream_in_2_copy, %"class.hls::stream.3"* %stream_out_copy, i32 %image_w, i32 %image_h)
  call fastcc void @copy_out(%"class.hls::stream"* %stream_in_1, %"class.hls::stream"* nonnull align 512 %stream_in_1_copy, %"class.hls::stream"* %stream_in_2, %"class.hls::stream"* nonnull align 512 %stream_in_2_copy, %"class.hls::stream.3"* %stream_out, %"class.hls::stream.3"* nonnull align 512 %stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.3"*, %"class.hls::stream.3"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.3"*, %"class.hls::stream.3"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_GradConvolutionUnit_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.3"*, i32, i32)

define void @GradConvolutionUnit_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.3"*, i32, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.3"* null, %"class.hls::stream.3"* %2)
  call void @GradConvolutionUnit_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream.3"* %2, i32 %3, i32 %4)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.3"* null, %"class.hls::stream.3"* %2)
  ret void
}

declare void @GradConvolutionUnit_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.3"*, i32, i32)
