...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_GradConvolutionUnit_0_0_stub.v
...
(* X_CORE_INFO = "GradConvolutionUnit,Vivado 2020.2" *)
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, ap_start, ap_done, ap_idle, 
  ...
  stream_in_2_TSTRB, stream_in_2_TUSER, stream_out_TVALID, stream_out_TREADY, 
  stream_out_TDATA, stream_out_TLAST, stream_out_TKEEP, stream_out_TSTRB, stream_out_TUSER, 
  image_w, image_h)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,stream_in_1_TVALID,stream_in_1_TREADY,stream_in_1_TDATA[7:0],stream_in_1_TLAST[0:0],stream_in_1_TKEEP[0:0],stream_in_1_TSTRB[0:0],stream_in_1_TUSER[0:0],stream_in_2_TVALID,stream_in_2_TREADY,stream_in_2_TDATA[7:0],stream_in_2_TLAST[0:0],stream_in_2_TKEEP[0:0],stream_in_2_TSTRB[0:0],stream_in_2_TUSER[0:0],stream_out_TVALID,stream_out_TREADY,stream_out_TDATA[15:0],stream_out_TLAST[0:0],stream_out_TKEEP[1:0],stream_out_TSTRB[1:0],stream_out_TUSER[0:0],image_w[31:0],image_h[31:0]" */;
  input ap_clk;
  input ap_rst_n;
  input ap_start;
  output ap_done;
